...
- Terraform GitHub workflows pin the Terraform CLI to `1.12.2` instead of floating on `latest`, so upstream Terraform releases do not unexpectedly break PR validation or plan/apply jobs.
